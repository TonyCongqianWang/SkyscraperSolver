		...
		int remaining_entropy)
{
	...
	cfg->lookahead.check_mode.downgrade_fraction
		= g_shallow_lookahead_downgrade_fraction;
}
...
static void	setup_cfg_bounds(t_prune_routine_cfg *cfg, int num_unset)
{
	...
	cfg->check_constr_global_min_entropy
		= calc_effective_global_min_entropy(
			g_shallow_constr_global_min_entropy, num_unset);
	...
	cfg->lookahead.check_mode.constr.global_min_entropy
		= calc_effective_global_min_entropy(
			g_shallow_lookahead_constr_global_min_entropy, num_unset);
	...
	cfg->lookahead.check_mode.gac.global_min_entropy
		= calc_effective_global_min_entropy(
			g_shallow_lookahead_gac_global_min_entropy, num_unset);
}
