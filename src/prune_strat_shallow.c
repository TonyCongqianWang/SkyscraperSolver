...
static void	setup_cfg_bounds(t_prune_routine_cfg *cfg)
{
	...
	cfg->gac.global_min_entropy = g_shallow_gac_global_min_entropy;
	...
	cfg->check_constr_global_min_entropy
		= g_shallow_constr_global_min_entropy;
...
static double	calc_period(t_puzzle *puzzle, t_node_state *node)
{
	...
	return (g_shallow_period_coef_sqrt * dsqrt_approx(raw)
		+ g_shallow_period_coef_inv * raw
