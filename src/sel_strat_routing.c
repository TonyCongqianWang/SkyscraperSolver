...
static const double			g_sel_rebuild_period = 1439;
static const double			g_sel_ord2_coeff = 1921.66666666667;
static const double			g_sel_ord4_coeff = 77651.6666666667;
