...
{
	cfg->run_gac = (remaining_entropy >= g_medium_gac_min_entropy);
	cfg->run_check_constr = (remaining_entropy >= g_medium_constr_min_entropy);
	...
	cfg->lookahead.check_mode.lookahead_continue_min_entropy
		= g_medium_lookahead_continue_min_entropy;
	cfg->lookahead.check_mode.lookahead_continue_slope
		= g_medium_lookahead_continue_slope;
}
...
static void	setup_cfg_bounds(t_prune_routine_cfg *cfg, int num_unset, int size)
{
	...
	cfg->check_constr_global_min_entropy
		= calc_effective_global_min_entropy(
			g_medium_constr_global_min_entropy, num_unset, size);
	...
	cfg->lookahead.check_mode.constr.global_min_entropy
		= calc_effective_global_min_entropy(
			g_medium_lookahead_constr_global_min_entropy, num_unset, size);
	...
	cfg->lookahead.check_mode.gac.global_min_entropy
		= calc_effective_global_min_entropy(
			g_medium_lookahead_gac_global_min_entropy, num_unset, size);
}
