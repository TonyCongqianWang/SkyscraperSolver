...
double	g_shallow_period_coef_scale = 76.64863741082324;
...
double	g_medium_period_coef_scale = 224.16628738222903;
...
double	g_deep_period_coef_scale = 3652.487037930031;
