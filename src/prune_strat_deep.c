...
{
	lim->gac_min_entropy = g_deep_gac_min_entropy;
	lim->constr_min_entropy = g_deep_constr_min_entropy;
	lim->lh_continue_min_entropy = g_deep_lookahead_continue_min_entropy;
	lim->lh_continue_slope = g_deep_lookahead_continue_slope;
	lim->gac_local_min_entropy = g_deep_gac_local_min_entropy;
	lim->gac_local_max_entropy = g_deep_gac_local_max_entropy;
	lim->gac_global_min_entropy = g_deep_gac_global_min_entropy;
	lim->constr_local_min_entropy = g_deep_constr_local_min_entropy;
	lim->constr_local_max_entropy = g_deep_constr_local_max_entropy;
	lim->constr_global_min_entropy = g_deep_constr_global_min_entropy;
...
static double	calc_period(t_puzzle *puzzle, t_node_state *node)
{
	...
	return (g_deep_period_coef_scale * dpow075_approx(raw)
