...
PARAM_METADATA = [
    ...
    # ENTROPY WEIGHTS
    ("WEIGHT_CELL_CONSTR_RATIO_LE7", 0.0, 1.0, 0.68250525, float, 0.005),
    ("WEIGHT_CELL_CONSTR_RATIO_S8", 0.0, 1.0, 0.74980148, float, 0.005),
    ("WEIGHT_CELL_CONSTR_RATIO_S9", 0.0, 1.0, 0.58622085, float, 0.005),
    ("WEIGHT_TOTAL_SCALE_LE7", 1000.0, 8000.0, 5044.375, float, 0.2),
    ("WEIGHT_TOTAL_SCALE_S8", 1000.0, 8000.0, 2326.27783, float, 0.2),
    ("WEIGHT_TOTAL_SCALE_S9", 1000.0, 8000.0, 3167.26416, float, 0.2),
    # SELECTION HEURISTIC PARAMETERS
    ("SEL_WEIGHT_CELL_CONSTR_RATIO_LE7", 0.0, 1.0, 0.08740957, float, 0.005),
    ("SEL_WEIGHT_CELL_CONSTR_RATIO_S8", 0.0, 1.0, 0.06795293, float, 0.005),
    ("SEL_WEIGHT_CELL_CONSTR_RATIO_S9", 0.0, 1.0, 0.07538318, float, 0.005),
    ("SEL_POWER_LE7", -2.0, 1.0, -0.826815000000001, float, 0.1),
    ("SEL_POWER_S8", -2.0, 1.0, -0.696103680477041, float, 0.1),
    ("SEL_POWER_S9", -2.0, 1.0, -0.826815000000001, float, 0.1),
    ...
    ("LOOKAHEAD_SCORE_WEIGHT_SPLIT1_S8", 0.0, 1.0, 0.2, float, 0.05),
    ("LOOKAHEAD_SCORE_WEIGHT_SPLIT1_S9", 0.0, 1.0, 0.2, float, 0.05),
    ("LOOKAHEAD_ENTROPY_WEIGHT_LE7", 0.0, 0.5, 0.02, float, 0.02),
    ("LOOKAHEAD_ENTROPY_WEIGHT_S8", 0.0, 0.5, 0.02, float, 0.02),
    ("LOOKAHEAD_ENTROPY_WEIGHT_S9", 0.0, 0.5, 0.02, float, 0.02),
    ("LOOKAHEAD_SCORE_AGE_LIMIT_RATIO_LE7", 0.0, 0.1, 0.02, float, 0.02),
    ("LOOKAHEAD_SCORE_AGE_LIMIT_RATIO_S8", 0.0, 0.1, 0.02, float, 0.02),
    ("LOOKAHEAD_SCORE_AGE_LIMIT_RATIO_S9", 0.0, 0.1, 0.02, float, 0.02),
    # ROOT
    ("ROOT_MIN_ENTROPY", 0, 1027080, 88226, int, 1.0),
    ("ROOT_GAC_MIN_ENTROPY", 0, 1027080, 206208, int, 1.0),
    ("ROOT_CONSTR_MIN_ENTROPY", 0, 1027080, 84832, int, 1.0),
    ("ROOT_PERIOD_COEF_SCALE", 1.0, 1000.0, 91.0917961629744, float, 1.0),
    ("ROOT_PERIOD_COEF_UNSET", 0.0, 100.0, 0.120497533760074, float, 1.0),
    # SHALLOW
    ("SHALLOW_MIN_ENTROPY", 0, 1027080, 271289, int, 1.0),
    ("SHALLOW_GAC_MIN_ENTROPY", 0, 1027080, 171538, int, 1.0),
    ("SHALLOW_CONSTR_MIN_ENTROPY", 0, 1027080, 370656, int, 1.0),
    ("SHALLOW_PERIOD_COEF_SCALE", 1.0, 1000.0, 104.062934059516, float, 1.0),
    ("SHALLOW_PERIOD_COEF_UNSET", 0.0, 100.0, 2.0518755341851, float, 1.0),
    # MEDIUM
    ("MEDIUM_MIN_ENTROPY", 0, 1027080, 125812, int, 1.0),
    ("MEDIUM_GAC_MIN_ENTROPY", 0, 1027080, 26608, int, 1.0),
    ("MEDIUM_CONSTR_MIN_ENTROPY", 0, 1027080, 149874, int, 1.0),
    ("MEDIUM_PERIOD_COEF_SCALE", 1.0, 2000.0, 187.24202503854, float, 1.0),
    ("MEDIUM_PERIOD_COEF_UNSET", 0.0, 100.0, 0.377897681558168, float, 1.0),
    # DEEP
    ("DEEP_MIN_ENTROPY", 0, 1027080, 258200, int, 1.0),
    ("DEEP_GAC_MIN_ENTROPY", 0, 1027080, 241141, int, 1.0),
    ("DEEP_CONSTR_MIN_ENTROPY", 0, 1027080, 483828, int, 1.0),
    ("DEEP_PERIOD_COEF_SCALE", 1.0, 5000.0, 438.266967270976, float, 1.0),
    ("DEEP_PERIOD_COEF_UNSET", 0.0, 100.0, 9.28963121918442, float, 1.0),
    # NODE SELECT SELECTIVITY ROUTING
    ("SEL_PERIOD_COEF_SQRT", 0.0, 100000.0, 1152.51655725682, float, 1.0),
    ("SEL_PERIOD_COEF_INV", 0.0, 100000.0, 11585.3213420776, float, 1.0),
    # DYNAMIC ENTROPY LOOKAHEAD CONTINUATION THRESHOLDS & ESCALATION SLOPES
    ("ROOT_LOOKAHEAD_CONTINUE_MIN_ENTROPY", 0, 1027080, 74751, int, 1.0),
    ("ROOT_LOOKAHEAD_CONTINUE_SLOPE", 0.0, 5.0, 0.747909286831489, float, 1.0),
    ("SHALLOW_LOOKAHEAD_CONTINUE_MIN_ENTROPY", 0, 1027080, 261051, int, 1.0),
    ("SHALLOW_LOOKAHEAD_CONTINUE_SLOPE", 0.0, 5.0, 0.683857212284032, float, 1.0),
    ("MEDIUM_LOOKAHEAD_CONTINUE_MIN_ENTROPY", 0, 1027080, 177954, int, 1.0),
    ("MEDIUM_LOOKAHEAD_CONTINUE_SLOPE", 0.0, 5.0, 0.289505195863751, float, 1.0),
    ("DEEP_LOOKAHEAD_CONTINUE_MIN_ENTROPY", 0, 1027080, 222871, int, 1.0),
    ("DEEP_LOOKAHEAD_CONTINUE_SLOPE", 0.0, 5.0, 0.613197394003615, float, 1.0),
    # ROOT LOCAL/GLOBAL BOUNDS
    ("ROOT_GAC_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.0411628176178357, float, 0.2),
    ("ROOT_GAC_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.902433742864046, float, 0.2),
    ("ROOT_GAC_GLOBAL_MIN_ENTROPY", 0, 1027080, 549358, int, 1.0),
    ("ROOT_CONSTR_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.0117725302994981, float, 0.2),
    ("ROOT_CONSTR_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.885039448743101, float, 0.2),
    ("ROOT_CONSTR_GLOBAL_MIN_ENTROPY", 0, 1027080, 573647, int, 1.0),
    ("ROOT_LOOKAHEAD_GAC_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.00252432466778238, float, 0.2),
    ("ROOT_LOOKAHEAD_GAC_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.887327795073174, float, 0.2),
    ("ROOT_LOOKAHEAD_GAC_GLOBAL_MIN_ENTROPY", 0, 1027080, 614983, int, 1.0),
    ("ROOT_LOOKAHEAD_CONSTR_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.0142919834081288, float, 0.2),
    ("ROOT_LOOKAHEAD_CONSTR_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.928069107488616, float, 0.2),
    ("ROOT_LOOKAHEAD_CONSTR_GLOBAL_MIN_ENTROPY", 0, 1027080, 484527, int, 1.0),
    # SHALLOW LOCAL/GLOBAL BOUNDS
    ("SHALLOW_GAC_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.032501588876128, float, 0.2),
    ("SHALLOW_GAC_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.90992069380417, float, 0.2),
    ("SHALLOW_GAC_GLOBAL_MIN_ENTROPY", 0, 1027080, 636194, int, 1.0),
    ("SHALLOW_CONSTR_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.018300708487346, float, 0.2),
    ("SHALLOW_CONSTR_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.839379686235423, float, 0.2),
    ("SHALLOW_CONSTR_GLOBAL_MIN_ENTROPY", 0, 1027080, 367883, int, 1.0),
    ("SHALLOW_LOOKAHEAD_GAC_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.00939410946870287, float, 0.2),
    ("SHALLOW_LOOKAHEAD_GAC_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.85477266514586, float, 0.2),
    ("SHALLOW_LOOKAHEAD_GAC_GLOBAL_MIN_ENTROPY", 0, 1027080, 810199, int, 1.0),
    ("SHALLOW_LOOKAHEAD_CONSTR_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.0147423969285342, float, 0.2),
    ("SHALLOW_LOOKAHEAD_CONSTR_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.890255126094919, float, 0.2),
    ("SHALLOW_LOOKAHEAD_CONSTR_GLOBAL_MIN_ENTROPY", 0, 1027080, 672795, int, 1.0),
    # MEDIUM LOCAL/GLOBAL BOUNDS
    ("MEDIUM_GAC_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.0188934234744788, float, 0.2),
    ("MEDIUM_GAC_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.943083339384124, float, 0.2),
    ("MEDIUM_GAC_GLOBAL_MIN_ENTROPY", 0, 1027080, 572502, int, 1.0),
    ("MEDIUM_CONSTR_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.0423041365174394, float, 0.2),
    ("MEDIUM_CONSTR_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.886665136934788, float, 0.2),
    ("MEDIUM_CONSTR_GLOBAL_MIN_ENTROPY", 0, 1027080, 240931, int, 1.0),
    ("MEDIUM_LOOKAHEAD_GAC_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.0126636959994719, float, 0.2),
    ("MEDIUM_LOOKAHEAD_GAC_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.729648910278397, float, 0.2),
    ("MEDIUM_LOOKAHEAD_GAC_GLOBAL_MIN_ENTROPY", 0, 1027080, 498860, int, 1.0),
    ("MEDIUM_LOOKAHEAD_CONSTR_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.0198990730419891, float, 0.2),
    ("MEDIUM_LOOKAHEAD_CONSTR_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.913104539055982, float, 0.2),
    ("MEDIUM_LOOKAHEAD_CONSTR_GLOBAL_MIN_ENTROPY", 0, 1027080, 532862, int, 1.0),
    # DEEP LOCAL/GLOBAL BOUNDS
    ("DEEP_GAC_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.0333407743036445, float, 0.2),
    ("DEEP_GAC_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.786543088919962, float, 0.2),
    ("DEEP_GAC_GLOBAL_MIN_ENTROPY", 0, 1027080, 564562, int, 1.0),
    ("DEEP_CONSTR_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.0323201461871107, float, 0.2),
    ("DEEP_CONSTR_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.839568756382252, float, 0.2),
    ("DEEP_CONSTR_GLOBAL_MIN_ENTROPY", 0, 1027080, 430015, int, 1.0),
    ("DEEP_LOOKAHEAD_GAC_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.00285057732760737, float, 0.2),
    ("DEEP_LOOKAHEAD_GAC_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.938529571183184, float, 0.2),
    ("DEEP_LOOKAHEAD_GAC_GLOBAL_MIN_ENTROPY", 0, 1027080, 432755, int, 1.0),
    ("DEEP_LOOKAHEAD_CONSTR_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.0137186314078999, float, 0.2),
    ("DEEP_LOOKAHEAD_CONSTR_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.834118375657608, float, 0.2),
    ("DEEP_LOOKAHEAD_CONSTR_GLOBAL_MIN_ENTROPY", 0, 1027080, 499643, int, 1.0),
    # TIER MULTIPLIERS
    ("ROOT_PERIOD_TIER_MEDIUM_MULTIPLIER", 1.0, 10.0, 2.03621060166807, float, 1.0),
    ("ROOT_PERIOD_TIER_HEAVY_MULTIPLIER", 1.0, 20.0, 3.87040071506615, float, 1.0),
    ("ROOT_PERIOD_TIER_COMPLEMENT_MULTIPLIER", 1.0, 20.0, 4.05074412956119, float, 0.5),
    ("SHALLOW_PERIOD_TIER_MEDIUM_MULTIPLIER", 1.0, 10.0, 1.97880807281783, float, 1.0),
    ("SHALLOW_PERIOD_TIER_HEAVY_MULTIPLIER", 1.0, 20.0, 3.44322775941671, float, 1.0),
    ("MEDIUM_PERIOD_TIER_MEDIUM_MULTIPLIER", 1.0, 10.0, 2.69144472005427, float, 1.0),
    ("MEDIUM_PERIOD_TIER_HEAVY_MULTIPLIER", 1.0, 20.0, 4.3955248082211, float, 1.0),
    ("DEEP_PERIOD_TIER_MEDIUM_MULTIPLIER", 1.0, 10.0, 1.96106757676093, float, 1.0),
    ("DEEP_PERIOD_TIER_HEAVY_MULTIPLIER", 1.0, 20.0, 3.77658441137951, float, 1.0),
]
...
for name, *etc in PARAM_METADATA:
    if "_BIAS" in name or "_FP" in name or "SEL_POWER" in name or "SPLIT" in name or "ENTROPY_WEIGHT" in name or "ROUTING" in name or "AGE_LIMIT" in name:
