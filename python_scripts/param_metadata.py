...
PARAM_METADATA = [
    ...
    ("ROOT_PERIOD_COEF_SCALE", 1.0, 1000.0, 100.0, float, 1.0),
    ...
    ("SHALLOW_PERIOD_COEF_SCALE", 1.0, 1000.0, 100.0, float, 1.0),
    ...
    ("MEDIUM_PERIOD_COEF_SCALE", 1.0, 2000.0, 250.0, float, 1.0),
    ...
    ("DEEP_PERIOD_COEF_SCALE", 1.0, 5000.0, 600.0, float, 1.0),
    ...
    ("ROOT_GAC_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.25973180527123735, float, 0.2),
    ("ROOT_GAC_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.874023986239067, float, 0.2),
    ("ROOT_GAC_GLOBAL_MIN_ENTROPY", 0, 1027080, 534208, int, 1.0),
    ("ROOT_CONSTR_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.26064501261065265, float, 0.2),
    ("ROOT_CONSTR_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.9126105341650526, float, 0.2),
    ("ROOT_CONSTR_GLOBAL_MIN_ENTROPY", 0, 1027080, 551339, int, 1.0),
    ("ROOT_LOOKAHEAD_GAC_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.2503278144967727, float, 0.2),
    ("ROOT_LOOKAHEAD_GAC_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.8765735453030373, float, 0.2),
    ("ROOT_LOOKAHEAD_GAC_GLOBAL_MIN_ENTROPY", 0, 1027080, 616350, int, 1.0),
    ("ROOT_LOOKAHEAD_CONSTR_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.23276766798962922, float, 0.2),
    ("ROOT_LOOKAHEAD_CONSTR_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.8840393905695386, float, 0.2),
    ("ROOT_LOOKAHEAD_CONSTR_GLOBAL_MIN_ENTROPY", 0, 1027080, 496734, int, 1.0),
    # SHALLOW LOCAL/GLOBAL BOUNDS
    ("SHALLOW_GAC_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.24811118930398296, float, 0.2),
    ("SHALLOW_GAC_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.8749166261562161, float, 0.2),
    ("SHALLOW_GAC_GLOBAL_MIN_ENTROPY", 0, 1027080, 650046, int, 1.0),
    ("SHALLOW_CONSTR_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.25931738796163323, float, 0.2),
    ("SHALLOW_CONSTR_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.8982431059716437, float, 0.2),
    ("SHALLOW_CONSTR_GLOBAL_MIN_ENTROPY", 0, 1027080, 475872, int, 1.0),
    ("SHALLOW_LOOKAHEAD_GAC_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.23288633516328322, float, 0.2),
    ("SHALLOW_LOOKAHEAD_GAC_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.8498986082997585, float, 0.2),
    ("SHALLOW_LOOKAHEAD_GAC_GLOBAL_MIN_ENTROPY", 0, 1027080, 759767, int, 1.0),
    ("SHALLOW_LOOKAHEAD_CONSTR_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.3631018758643103, float, 0.2),
    ("SHALLOW_LOOKAHEAD_CONSTR_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.9038017369503237, float, 0.2),
    ("SHALLOW_LOOKAHEAD_CONSTR_GLOBAL_MIN_ENTROPY", 0, 1027080, 467044, int, 1.0),
    # MEDIUM LOCAL/GLOBAL BOUNDS
    ("MEDIUM_GAC_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.24910795309196465, float, 0.2),
    ("MEDIUM_GAC_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.8769915343370689, float, 0.2),
    ("MEDIUM_GAC_GLOBAL_MIN_ENTROPY", 0, 1027080, 549305, int, 1.0),
    ("MEDIUM_CONSTR_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.25493120160029764, float, 0.2),
    ("MEDIUM_CONSTR_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.8545458587101036, float, 0.2),
    ("MEDIUM_CONSTR_GLOBAL_MIN_ENTROPY", 0, 1027080, 255546, int, 1.0),
    ("MEDIUM_LOOKAHEAD_GAC_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.240504752553489, float, 0.2),
    ("MEDIUM_LOOKAHEAD_GAC_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.8601715211423747, float, 0.2),
    ("MEDIUM_LOOKAHEAD_GAC_GLOBAL_MIN_ENTROPY", 0, 1027080, 523920, int, 1.0),
    ("MEDIUM_LOOKAHEAD_CONSTR_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.2560716761364065, float, 0.2),
    ("MEDIUM_LOOKAHEAD_CONSTR_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.8922129640531624, float, 0.2),
    ("MEDIUM_LOOKAHEAD_CONSTR_GLOBAL_MIN_ENTROPY", 0, 1027080, 551478, int, 1.0),
    # DEEP LOCAL/GLOBAL BOUNDS
    ("DEEP_GAC_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.28122234575245253, float, 0.2),
    ("DEEP_GAC_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.8585677707652279, float, 0.2),
    ("DEEP_GAC_GLOBAL_MIN_ENTROPY", 0, 1027080, 510812, int, 1.0),
    ("DEEP_CONSTR_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.2659112015907732, float, 0.2),
    ("DEEP_CONSTR_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.8757376309495251, float, 0.2),
    ("DEEP_CONSTR_GLOBAL_MIN_ENTROPY", 0, 1027080, 450839, int, 1.0),
    ("DEEP_LOOKAHEAD_GAC_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.23993727267459564, float, 0.2),
    ("DEEP_LOOKAHEAD_GAC_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.8859350540278806, float, 0.2),
    ("DEEP_LOOKAHEAD_GAC_GLOBAL_MIN_ENTROPY", 0, 1027080, 399383, int, 1.0),
    ("DEEP_LOOKAHEAD_CONSTR_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.2739735577902606, float, 0.2),
    ("DEEP_LOOKAHEAD_CONSTR_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.8504496723799425, float, 0.2),
