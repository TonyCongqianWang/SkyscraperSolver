...
PARAM_METADATA = [
    ...
    # SHALLOW
    ("SHALLOW_MIN_ENTROPY", 0, 1027080, 203729, int, 0.1),
    ("SHALLOW_GAC_MIN_ENTROPY", 0, 1027080, 188814, int, 0.1),
    ("SHALLOW_CONSTR_MIN_ENTROPY", 0, 1027080, 359189, int, 0.1),
    ...
    ("MEDIUM_CONSTR_MIN_ENTROPY", 0, 1027080, 57752, int, 0.1),
    ...
    ("SHALLOW_LOOKAHEAD_CONTINUE_MIN_ENTROPY", 0, 1027080, 271030, int, 0.1),
    ...
    ("ROOT_CONSTR_GLOBAL_MIN_ENTROPY", 0, 1027080, 557927, int, 0.1),
