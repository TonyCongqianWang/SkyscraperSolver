...
PARAM_METADATA = [
    ...
    ("WEIGHT_TOTAL_SCALE_LE7", 100.0, 15000.0, 5044.375, float, 5.0),
    ("WEIGHT_TOTAL_SCALE_S8", 100.0, 15000.0, 2326.27783, float, 5.0),
    ("WEIGHT_TOTAL_SCALE_S9", 100.0, 15000.0, 3167.26416, float, 5.0),
