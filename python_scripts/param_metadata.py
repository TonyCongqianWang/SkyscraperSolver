...
PARAM_METADATA = [
    ...
    ("GLOBAL_ENTROPY_UNSET_BIAS", 100.0, 2000.0, 516.9600000000003, float, 1.0),
    ("GLOBAL_ENTROPY_UNSET_BIAS_S7", 100.0, 2000.0, 510.7316158005513, float, 1.0),
    ("GLOBAL_ENTROPY_UNSET_BIAS_S8", 100.0, 2000.0, 505.880958142554, float, 1.0),
    ("GLOBAL_ENTROPY_UNSET_BIAS_S9", 100.0, 2000.0, 516.9600000000003, float, 1.0),
    # ENTROPY WEIGHT REPARAMETERIZATION (Direction & Magnitude in Fixed-Point)
    ("WEIGHT_CELL_CONSTR_RATIO_FP", 1024, 12288, 4441, int, 1.0),
    ("WEIGHT_CELL_CONSTR_RATIO_FP_S7", 1024, 12288, 4446, int, 1.0),
    ("WEIGHT_CELL_CONSTR_RATIO_FP_S8", 1024, 12288, 4462, int, 1.0),
    ("WEIGHT_CELL_CONSTR_RATIO_FP_S9", 1024, 12288, 4441, int, 1.0),
    ("WEIGHT_TOTAL_SCALE_FP", 256, 4096, 1135, int, 1.0),
    ("WEIGHT_TOTAL_SCALE_FP_S7", 256, 4096, 1125, int, 1.0),
    ("WEIGHT_TOTAL_SCALE_FP_S8", 256, 4096, 1164, int, 1.0),
