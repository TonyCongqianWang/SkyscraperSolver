...
PARAM_METADATA = [
    # ROUTING
    ("ROUTING_SHALLOW_RATIO", 0.0, 0.3, 0.225468147090973, float),
    ("ROUTING_MEDIUM_RATIO", 0.0, 0.5, 0.349151988586, float),
    # ROOT
    ("ROOT_MIN_UNSET", 0.0, 0.5, 0.201176982334429, float),
    ("ROOT_GAC_UNSET_THRESHOLD", 0.1, 1.0, 0.132431740614728, float),
    ("ROOT_CONSTR_MIN_UNSET", 0.0, 1.0, 0.0255441138829879, float),
    ("ROOT_PERIOD_BASE", 3, 250, 10, int),
    ("ROOT_PERIOD_COEF1", 0, 25000, 2414, int),
    ("ROOT_PERIOD_COEF2", 0, 375000, 30384, int),
    # SHALLOW
    ("SHALLOW_MIN_UNSET", 0.0, 0.5, 0.475080054455575, float),
    ("SHALLOW_GAC_UNSET_THRESHOLD", 0.1, 1.0, 0.176698143667522, float),
    ("SHALLOW_CONSTR_MIN_UNSET", 0.0, 1.0, 0.407052478170046, float),
    ("SHALLOW_PERIOD_BASE", 3, 500, 36, int),
    ("SHALLOW_PERIOD_COEF1", 0, 37500, 355, int),
    ("SHALLOW_PERIOD_COEF2", 0, 375000, 1653, int),
    # MEDIUM
    ("MEDIUM_MIN_UNSET", 0.0, 0.5, 0.373143792762316, float),
    ("MEDIUM_GAC_UNSET_THRESHOLD", 0.1, 1.0, 0.153672995124571, float),
    ("MEDIUM_CONSTR_MIN_UNSET", 0.0, 1.0, 0.296843412573555, float),
    ("MEDIUM_PERIOD_BASE", 3, 750, 140, int),
    ("MEDIUM_PERIOD_COEF1", 0, 25000, 15624, int),
    ("MEDIUM_PERIOD_COEF2", 0, 375000, 294370, int),
    # DEEP
    ("DEEP_MIN_UNSET", 0.0, 0.5, 0.147323252537786, float),
    ("DEEP_GAC_UNSET_THRESHOLD", 0.1, 1.0, 0.25163080557056, float),
    ("DEEP_CONSTR_MIN_UNSET", 0.0, 1.0, 0.484302699783326, float),
    ("DEEP_PERIOD_BASE", 3, 1000, 657, int),
    ("DEEP_PERIOD_COEF1", 0, 50000, 27352, int),
    ("DEEP_PERIOD_COEF2", 0, 375000, 216954, int),
    # NODE SELECT SELECTIVITY ROUTING
    ("SEL_REBUILD_PERIOD", 3, 25000, 3128, int),
    ("SEL_ORD2_COEFF", 0, 125000, 4834, int),
    ("SEL_ORD4_COEFF", 0, 1250000, 160229, int),
    # ROOT LOOKAHEAD
    ("ROOT_LOOKAHEAD_GAC_UNSET_THRESHOLD", 0.1, 1.0, 0.143922145770238, float),
    ("ROOT_LOOKAHEAD_CONSTR_MIN_UNSET", 0.0, 1.0, 0.0224225088807007, float),
    # SHALLOW LOOKAHEAD
    ("SHALLOW_LOOKAHEAD_GAC_UNSET_THRESHOLD", 0.1, 1.0, 0.140379618059519, float),
    ("SHALLOW_LOOKAHEAD_CONSTR_MIN_UNSET", 0.0, 1.0, 0.444943533302001, float),
    # MEDIUM LOOKAHEAD
    ("MEDIUM_LOOKAHEAD_GAC_UNSET_THRESHOLD", 0.1, 1.0, 0.174760930919788, float),
    ("MEDIUM_LOOKAHEAD_CONSTR_MIN_UNSET", 0.0, 1.0, 0.330607351088428, float),
    # DEEP LOOKAHEAD
    ("DEEP_LOOKAHEAD_GAC_UNSET_THRESHOLD", 0.1, 1.0, 0.224965676901898, float),
    ("DEEP_LOOKAHEAD_CONSTR_MIN_UNSET", 0.0, 1.0, 0.509642279393748, float),
    # LOOKAHEAD DOWNGRADE FRACTIONS
    ("ROOT_LOOKAHEAD_DOWNGRADE_FRACTION", 0.0, 1.0, 0.0714845042243065, float),
    ("SHALLOW_LOOKAHEAD_DOWNGRADE_FRACTION", 0.0, 1.0, 0.00292315831140779, float),
    ("MEDIUM_LOOKAHEAD_DOWNGRADE_FRACTION", 0.0, 1.0, 0.0177461080331954, float),
    ("DEEP_LOOKAHEAD_DOWNGRADE_FRACTION", 0.0, 1.0, 0.0496186985535093, float),
    # ROOT LOCAL BOUNDS
    ("ROOT_GAC_LOCAL_MIN_UNSET", 0.0, 1.0, 0.351998502494427, float),
    ("ROOT_GAC_LOCAL_MAX_UNSET", 0.0, 1.0, 0.70509433900373, float),
    ("ROOT_GAC_LOCAL_GLOBAL_MIN_UNSET", 0.0, 1.0, 0.495231407740633, float),
    ("ROOT_CONSTR_LOCAL_MIN_UNSET", 0.0, 1.0, 0.356143040960021, float),
    ("ROOT_CONSTR_LOCAL_MAX_UNSET", 0.0, 1.0, 0.701397240553604, float),
    ("ROOT_CONSTR_LOCAL_GLOBAL_MIN_UNSET", 0.0, 1.0, 0.505964265587367, float),
    ("ROOT_LOOKAHEAD_LOCAL_MIN_UNSET", 0.0, 1.0, 0.339262188833763, float),
    ("ROOT_LOOKAHEAD_LOCAL_MAX_UNSET", 0.0, 1.0, 0.691937712171258, float),
    ("ROOT_LOOKAHEAD_LOCAL_GLOBAL_MIN_UNSET", 0.0, 1.0, 0.502735349801847, float),
    # SHALLOW LOCAL BOUNDS
    ("SHALLOW_GAC_LOCAL_MIN_UNSET", 0.0, 1.0, 0.352644647244626, float),
    ("SHALLOW_GAC_LOCAL_MAX_UNSET", 0.0, 1.0, 0.701939585502893, float),
    ("SHALLOW_GAC_LOCAL_GLOBAL_MIN_UNSET", 0.0, 1.0, 0.501755052591313, float),
    ("SHALLOW_CONSTR_LOCAL_MIN_UNSET", 0.0, 1.0, 0.347952569103658, float),
    ("SHALLOW_CONSTR_LOCAL_MAX_UNSET", 0.0, 1.0, 0.711368740568488, float),
    ("SHALLOW_CONSTR_LOCAL_GLOBAL_MIN_UNSET", 0.0, 1.0, 0.491014060530055, float),
    ("SHALLOW_LOOKAHEAD_LOCAL_MIN_UNSET", 0.0, 1.0, 0.37158241397621, float),
    ("SHALLOW_LOOKAHEAD_LOCAL_MAX_UNSET", 0.0, 1.0, 0.700609814837593, float),
    ("SHALLOW_LOOKAHEAD_LOCAL_GLOBAL_MIN_UNSET", 0.0, 1.0, 0.504145010443604, float),
    # MEDIUM LOCAL BOUNDS
    ("MEDIUM_GAC_LOCAL_MIN_UNSET", 0.0, 1.0, 0.349294290847175, float),
    ("MEDIUM_GAC_LOCAL_MAX_UNSET", 0.0, 1.0, 0.70581613992226, float),
    ("MEDIUM_GAC_LOCAL_GLOBAL_MIN_UNSET", 0.0, 1.0, 0.508836305102866, float),
    ("MEDIUM_CONSTR_LOCAL_MIN_UNSET", 0.0, 1.0, 0.351623997582612, float),
    ("MEDIUM_CONSTR_LOCAL_MAX_UNSET", 0.0, 1.0, 0.700698680804623, float),
    ("MEDIUM_CONSTR_LOCAL_GLOBAL_MIN_UNSET", 0.0, 1.0, 0.503072030545533, float),
    ("MEDIUM_LOOKAHEAD_LOCAL_MIN_UNSET", 0.0, 1.0, 0.352064456662411, float),
    ("MEDIUM_LOOKAHEAD_LOCAL_MAX_UNSET", 0.0, 1.0, 0.706320035221528, float),
    ("MEDIUM_LOOKAHEAD_LOCAL_GLOBAL_MIN_UNSET", 0.0, 1.0, 0.508692891499807, float),
    # DEEP LOCAL BOUNDS
    ("DEEP_GAC_LOCAL_MIN_UNSET", 0.0, 1.0, 0.335312411405018, float),
    ("DEEP_GAC_LOCAL_MAX_UNSET", 0.0, 1.0, 0.709976949255361, float),
    ("DEEP_GAC_LOCAL_GLOBAL_MIN_UNSET", 0.0, 1.0, 0.507991753163513, float),
    ("DEEP_CONSTR_LOCAL_MIN_UNSET", 0.0, 1.0, 0.348784613258523, float),
    ("DEEP_CONSTR_LOCAL_MAX_UNSET", 0.0, 1.0, 0.697641498524216, float),
    ("DEEP_CONSTR_LOCAL_GLOBAL_MIN_UNSET", 0.0, 1.0, 0.493074920019733, float),
    ("DEEP_LOOKAHEAD_LOCAL_MIN_UNSET", 0.0, 1.0, 0.367207746225102, float),
    ("DEEP_LOOKAHEAD_LOCAL_MAX_UNSET", 0.0, 1.0, 0.690675595985149, float),
    ("DEEP_LOOKAHEAD_LOCAL_GLOBAL_MIN_UNSET", 0.0, 1.0, 0.495012833236044, float),
]
