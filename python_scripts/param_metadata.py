...
PARAM_METADATA = [
    ...
    ("GLOBAL_ENTROPY_UNSET_BIAS_S9", 100.0, 2000.0, 587.333511480733, float, 1.0),
    # ENTROPY WEIGHTS
    ...
    ("WEIGHT_CELL_CONSTR_RATIO_S9", 0.0, 1.0, 0.680760019876136, float, 0.7),
    ...
    ("SEL_POWER_S8", -1.6, 0.5, -0.696103680477042, float, 0.02),
