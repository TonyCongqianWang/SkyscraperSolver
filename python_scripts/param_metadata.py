...
PARAM_METADATA = [
    ...
    ("ROUTING_SHALLOW_RATIO_S8", 0.0, 0.4, 0.131569382854444, float, 0.0156),
    ("ROUTING_SHALLOW_RATIO_S9", 0.0, 0.4, 0.00604603650081253, float, 0.0123),
    ("ROUTING_MEDIUM_RATIO_LE7", 0.0, 0.6, 0.35049047, float, 0.0204),
    ("ROUTING_MEDIUM_RATIO_S8", 0.0, 0.6, 0.343671506854062, float, 0.0156),
    ("ROUTING_MEDIUM_RATIO_S9", 0.0, 0.6, 0.381748910372413, float, 0.0123),
    ("GLOBAL_ENTROPY_UNSET_BIAS_LE7", 100.0, 800.0, 589.21814, float, 1.0),
    ("GLOBAL_ENTROPY_UNSET_BIAS_S8", 100.0, 800.0, 605.134510053887, float, 1.0),
    ("GLOBAL_ENTROPY_UNSET_BIAS_S9", 100.0, 800.0, 721.984349864311, float, 1.0),
    # ENTROPY WEIGHTS
    ("WEIGHT_CELL_CONSTR_RATIO_LE7", 0.35, 0.85, 0.692852818894837, float, 0.7),
    ("WEIGHT_CELL_CONSTR_RATIO_S8", 0.35, 0.85, 0.750694914496112, float, 0.7),
    ("WEIGHT_CELL_CONSTR_RATIO_S9", 0.35, 0.85, 0.666655999990975, float, 0.7),
    ("WEIGHT_TOTAL_SCALE_LE7", 1000.0, 8000.0, 5182.36527747058, float, 0.5),
    ("WEIGHT_TOTAL_SCALE_S8", 1000.0, 8000.0, 1478.87606882756, float, 0.5),
    ("WEIGHT_TOTAL_SCALE_S9", 1000.0, 8000.0, 1826.60186512754, float, 0.5),
    # SELECTION HEURISTIC PARAMETERS
    ("SEL_WEIGHT_CELL_CONSTR_RATIO_LE7", 0.0, 1.0, 0.02, float, 0.2),
    ("SEL_WEIGHT_CELL_CONSTR_RATIO_S8", 0.0, 1.0, 0.00675216624801475, float, 0.2),
    ("SEL_WEIGHT_CELL_CONSTR_RATIO_S9", 0.0, 1.0, 0.0324911824561573, float, 0.2),
    ("SEL_POWER_LE7", -1.6, 0.5, -0.826815000000003, float, 0.02),
    ("SEL_POWER_S8", -1.6, 0.5, -1.44159664548632, float, 0.02),
    ("SEL_POWER_S9", -1.6, 0.5, -0.52037454464543, float, 0.02),
    # LOOKAHEAD PARAMETERS
    ("LOOKAHEAD_SCORE_WEIGHT_SPLIT0_LE7", 0.0, 1.0, 0.15, float, 0.05),
    ("LOOKAHEAD_SCORE_WEIGHT_SPLIT0_S8", 0.0, 1.0, 0.152849944854971, float, 0.05),
    ("LOOKAHEAD_SCORE_WEIGHT_SPLIT0_S9", 0.0, 1.0, 0.465220388972287, float, 0.05),
    ("LOOKAHEAD_SCORE_WEIGHT_SPLIT1_LE7", 0.0, 1.0, 0.6, float, 0.05),
    ("LOOKAHEAD_SCORE_WEIGHT_SPLIT1_S8", 0.0, 1.0, 0.195828656288673, float, 0.05),
    ("LOOKAHEAD_SCORE_WEIGHT_SPLIT1_S9", 0.0, 1.0, 0.749896675443156, float, 0.05),
    ("LOOKAHEAD_ENTROPY_WEIGHT_LE7", 0.0, 0.5, 0.02, float, 1.0),
    ("LOOKAHEAD_ENTROPY_WEIGHT_S8", 0.0, 0.5, 0.12723773404151, float, 1.0),
    ("LOOKAHEAD_ENTROPY_WEIGHT_S9", 0.0, 0.5, 0.00412516824067685, float, 1.0),
    ...
    ("LOOKAHEAD_SCORE_AGE_LIMIT_RATIO_S9", 0.0, 0.1, 0.0885371823395848, float, 0.02),
    # ROOT
