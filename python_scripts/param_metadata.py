...
PARAM_METADATA = [
    ...
    ("GLOBAL_ENTROPY_UNSET_BIAS_S9", 100.0, 2000.0, 484.251982673356, float, 1.0),
    ...
    ("WEIGHT_CELL_CONSTR_RATIO_FP_S9", 1024, 12288, 4963, int, 1.0),
    ("WEIGHT_TOTAL_SCALE_FP_LE7", 256, 4096, 820, int, 1.0),
    ("WEIGHT_TOTAL_SCALE_FP_S8", 256, 4096, 663, int, 1.0),
    ("WEIGHT_TOTAL_SCALE_FP_S9", 256, 4096, 925, int, 1.0),
    ...
    ("SEL_WEIGHT_CELL_CONSTR_RATIO_FP_S9", 1024, 15360, 3565, int, 1.0),
    ("SEL_POWER_LE7", -5.0, 0.0, -1.19920433433856, float, 0.2),
    ("SEL_POWER_S8", -5.0, 0.0, -1.6795280213774, float, 0.2),
    ("SEL_POWER_S9", -5.0, 0.0, -2.68107366910565, float, 0.2),
    # ROOT
