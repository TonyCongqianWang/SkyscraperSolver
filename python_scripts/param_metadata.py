...
PARAM_METADATA = [
    ...
    ("GLOBAL_ENTROPY_UNSET_BIAS", 100.0, 2000.0, 508.45137330041, float, 1.0),
    # ENTROPY WEIGHTS
    ("WEIGHT_CELL", 100, 10000, 2000, int, 1.0),
    ("WEIGHT_CONSTR", 100, 10000, 1000, int, 1.0),
    # ROOT
    ...
    ("ROOT_LOOKAHEAD_DOWNGRADE_FRACTION", 0.0, 1.0, 0.4640393155229, float, 0.3),
    ("SHALLOW_LOOKAHEAD_DOWNGRADE_FRACTION", 0.0, 1.0, 0.32976599221386, float, 0.3),
    ("MEDIUM_LOOKAHEAD_DOWNGRADE_FRACTION", 0.0, 1.0, 0.31175615761573, float, 0.3),
    ("DEEP_LOOKAHEAD_DOWNGRADE_FRACTION", 0.0, 1.0, 0.2937463230176, float, 0.3),
...
PARAMETER_MAPPING = {
    ...
    # ENTROPY WEIGHTS
    "WEIGHT_CELL": ("src/params_int.c", "g_weight_cell", "int"),
    "WEIGHT_CONSTR": ("src/params_int.c", "g_weight_constr", "int"),
    # ROOT
