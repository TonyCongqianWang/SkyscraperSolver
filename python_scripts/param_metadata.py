...
PARAM_METADATA = [
    ...
    # ENTROPY WEIGHTS
    ("WEIGHT_CELL_CONSTR_RATIO_LE7", 0.0, 1.0, 0.68250525, float, 0.7),
    ("WEIGHT_CELL_CONSTR_RATIO_S8", 0.0, 1.0, 0.74980148, float, 0.7),
    ("WEIGHT_CELL_CONSTR_RATIO_S9", 0.0, 1.0, 0.58622085, float, 0.7),
    ("WEIGHT_TOTAL_SCALE_LE7", 1000.0, 8000.0, 5044.375, float, 4.0),
    ("WEIGHT_TOTAL_SCALE_S8", 1000.0, 8000.0, 2326.27783, float, 4.0),
    ("WEIGHT_TOTAL_SCALE_S9", 1000.0, 8000.0, 3167.26416, float, 4.0),
    # SELECTION HEURISTIC PARAMETERS
    ("SEL_WEIGHT_CELL_CONSTR_RATIO_LE7", 0.0, 1.0, 0.08740957, float, 0.9),
    ("SEL_WEIGHT_CELL_CONSTR_RATIO_S8", 0.0, 1.0, 0.06795293, float, 0.9),
    ("SEL_WEIGHT_CELL_CONSTR_RATIO_S9", 0.0, 1.0, 0.07538318, float, 0.9),
    ...
    ("LOOKAHEAD_ENTROPY_WEIGHT_S8", 0.0, 0.5, 0.02, float, 1.0),
