...
PARAM_METADATA = [
    ...
    ("WEIGHT_TOTAL_SCALE_LE7", 1000.0, 8000.0, 5182.36527747058, float, 4.0),
    ("WEIGHT_TOTAL_SCALE_S8", 1000.0, 8000.0, 2261.39985332911, float, 4.0),
    ("WEIGHT_TOTAL_SCALE_S9", 1000.0, 8000.0, 3799.98269739279, float, 4.0),
    # SELECTION HEURISTIC PARAMETERS
    ("SEL_WEIGHT_CELL_CONSTR_RATIO_LE7", 0.0, 1.0, 0.0545372275412134, float, 0.2),
    ("SEL_WEIGHT_CELL_CONSTR_RATIO_S8", 0.0, 1.0, 0.0490180531795142, float, 0.2),
    ...
    # ROOT
    ("ROOT_MIN_ENTROPY", 0, 1027080, 50680, int, 1.0),
    ("ROOT_GAC_MIN_ENTROPY", 0, 1027080, 175722, int, 1.0),
    ("ROOT_CONSTR_MIN_ENTROPY", 0, 1027080, 70827, int, 1.0),
    ("ROOT_PERIOD_COEF_SCALE", 1.0, 1000.0, 111.731021685774, float, 1.0),
    ("ROOT_PERIOD_COEF_UNSET", 0.0, 100.0, 0.636822494480381, float, 1.0),
    # SHALLOW
    ("SHALLOW_MIN_ENTROPY", 0, 1027080, 203729, int, 1.0),
    ("SHALLOW_GAC_MIN_ENTROPY", 0, 1027080, 188814, int, 1.0),
    ("SHALLOW_CONSTR_MIN_ENTROPY", 0, 1027080, 359189, int, 1.0),
    ("SHALLOW_PERIOD_COEF_SCALE", 1.0, 1000.0, 87.3846102750979, float, 1.0),
    ("SHALLOW_PERIOD_COEF_UNSET", 0.0, 100.0, 2.33738587349306, float, 1.0),
    # MEDIUM
    ("MEDIUM_MIN_ENTROPY", 0, 1027080, 127923, int, 1.0),
    ("MEDIUM_GAC_MIN_ENTROPY", 0, 1027080, 33515, int, 1.0),
    ("MEDIUM_CONSTR_MIN_ENTROPY", 0, 1027080, 57752, int, 1.0),
    ("MEDIUM_PERIOD_COEF_SCALE", 1.0, 2000.0, 133.177544738375, float, 1.0),
    ("MEDIUM_PERIOD_COEF_UNSET", 0.0, 100.0, 0.598936522455085, float, 1.0),
    # DEEP
    ("DEEP_MIN_ENTROPY", 0, 1027080, 269561, int, 1.0),
    ("DEEP_GAC_MIN_ENTROPY", 0, 1027080, 220473, int, 1.0),
    ("DEEP_CONSTR_MIN_ENTROPY", 0, 1027080, 445200, int, 1.0),
    ("DEEP_PERIOD_COEF_SCALE", 1.0, 5000.0, 600.510059511723, float, 1.0),
    ("DEEP_PERIOD_COEF_UNSET", 0.0, 100.0, 6.35293883168798, float, 1.0),
    # NODE SELECT SELECTIVITY ROUTING
    ("SEL_PERIOD_COEF_SQRT", 0.0, 100000.0, 2862.76093848253, float, 1.0),
    ("SEL_PERIOD_COEF_INV", 0.0, 100000.0, 12148.172145642, float, 1.0),
    # DYNAMIC ENTROPY LOOKAHEAD CONTINUATION THRESHOLDS & ESCALATION SLOPES
    ("ROOT_LOOKAHEAD_CONTINUE_MIN_ENTROPY", 0, 1027080, 66316, int, 1.0),
    ("ROOT_LOOKAHEAD_CONTINUE_SLOPE", 0.0, 5.0, 0.724384730313047, float, 1.0),
    ("SHALLOW_LOOKAHEAD_CONTINUE_MIN_ENTROPY", 0, 1027080, 271030, int, 1.0),
    ("SHALLOW_LOOKAHEAD_CONTINUE_SLOPE", 0.0, 5.0, 0.735069156876668, float, 1.0),
    ("MEDIUM_LOOKAHEAD_CONTINUE_MIN_ENTROPY", 0, 1027080, 194499, int, 1.0),
    ("MEDIUM_LOOKAHEAD_CONTINUE_SLOPE", 0.0, 5.0, 0.374840166143043, float, 1.0),
    ("DEEP_LOOKAHEAD_CONTINUE_MIN_ENTROPY", 0, 1027080, 250126, int, 1.0),
    ...
    ("ROOT_GAC_GLOBAL_MIN_ENTROPY", 0, 1027080, 573985, int, 1.0),
    ...
    ("ROOT_CONSTR_GLOBAL_MIN_ENTROPY", 0, 1027080, 557927, int, 1.0),
    ("ROOT_LOOKAHEAD_GAC_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.0165983644302228, float, 0.2),
    ("ROOT_LOOKAHEAD_GAC_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.881171226526941, float, 0.2),
    ("ROOT_LOOKAHEAD_GAC_GLOBAL_MIN_ENTROPY", 0, 1027080, 633838, int, 1.0),
    ...
    ("ROOT_LOOKAHEAD_CONSTR_GLOBAL_MIN_ENTROPY", 0, 1027080, 436088, int, 1.0),
    # SHALLOW LOCAL/GLOBAL BOUNDS
    ("SHALLOW_GAC_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.0804376357060443, float, 0.2),
    ("SHALLOW_GAC_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.914579439756111, float, 0.2),
    ("SHALLOW_GAC_GLOBAL_MIN_ENTROPY", 0, 1027080, 570160, int, 1.0),
    ...
    ("SHALLOW_CONSTR_GLOBAL_MIN_ENTROPY", 0, 1027080, 347490, int, 1.0),
    ("SHALLOW_LOOKAHEAD_GAC_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.0463466061324348, float, 0.2),
    ("SHALLOW_LOOKAHEAD_GAC_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.849538888175249, float, 0.2),
    ("SHALLOW_LOOKAHEAD_GAC_GLOBAL_MIN_ENTROPY", 0, 1027080, 823688, int, 1.0),
    ...
    ("SHALLOW_LOOKAHEAD_CONSTR_GLOBAL_MIN_ENTROPY", 0, 1027080, 697158, int, 1.0),
    ...
    ("MEDIUM_GAC_GLOBAL_MIN_ENTROPY", 0, 1027080, 543568, int, 1.0),
    ("MEDIUM_CONSTR_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.0755958976505369, float, 0.2),
    ("MEDIUM_CONSTR_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.872757627159424, float, 0.2),
    ("MEDIUM_CONSTR_GLOBAL_MIN_ENTROPY", 0, 1027080, 275389, int, 1.0),
    ("MEDIUM_LOOKAHEAD_GAC_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.0193113565388124, float, 0.2),
    ("MEDIUM_LOOKAHEAD_GAC_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.779977706835724, float, 0.2),
    ("MEDIUM_LOOKAHEAD_GAC_GLOBAL_MIN_ENTROPY", 0, 1027080, 481707, int, 1.0),
    ...
    ("MEDIUM_LOOKAHEAD_CONSTR_GLOBAL_MIN_ENTROPY", 0, 1027080, 546824, int, 1.0),
    ...
    ("DEEP_GAC_GLOBAL_MIN_ENTROPY", 0, 1027080, 577785, int, 1.0),
    ("DEEP_CONSTR_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.0460121663541498, float, 0.2),
    ("DEEP_CONSTR_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.832767577679931, float, 0.2),
    ("DEEP_CONSTR_GLOBAL_MIN_ENTROPY", 0, 1027080, 434819, int, 1.0),
    ("DEEP_LOOKAHEAD_GAC_LOCAL_MIN_ENTROPY", 0.0, 1.0, 0.00590201925668926, float, 0.2),
    ("DEEP_LOOKAHEAD_GAC_LOCAL_MAX_ENTROPY", 0.0, 1.0, 0.994150899321746, float, 0.2),
    ("DEEP_LOOKAHEAD_GAC_GLOBAL_MIN_ENTROPY", 0, 1027080, 415616, int, 1.0),
    ...
    ("DEEP_LOOKAHEAD_CONSTR_GLOBAL_MIN_ENTROPY", 0, 1027080, 466615, int, 1.0),
    # TIER MULTIPLIERS
    ("ROOT_PERIOD_TIER_MEDIUM_MULTIPLIER", 1.0, 10.0, 2.17483810796407, float, 1.0),
    ("ROOT_PERIOD_TIER_HEAVY_MULTIPLIER", 1.0, 20.0, 3.78927231786481, float, 1.0),
    ("ROOT_PERIOD_TIER_COMPLEMENT_MULTIPLIER", 1.0, 20.0, 4.27745526176766, float, 0.5),
    ("SHALLOW_PERIOD_TIER_MEDIUM_MULTIPLIER", 1.0, 10.0, 1.97534613804766, float, 1.0),
    ("SHALLOW_PERIOD_TIER_HEAVY_MULTIPLIER", 1.0, 20.0, 3.99669378231049, float, 1.0),
    ("MEDIUM_PERIOD_TIER_MEDIUM_MULTIPLIER", 1.0, 10.0, 2.84201822406732, float, 1.0),
    ("MEDIUM_PERIOD_TIER_HEAVY_MULTIPLIER", 1.0, 20.0, 5.01874410362026, float, 1.0),
    ("DEEP_PERIOD_TIER_MEDIUM_MULTIPLIER", 1.0, 10.0, 1.94203139690121, float, 1.0),
    ("DEEP_PERIOD_TIER_HEAVY_MULTIPLIER", 1.0, 20.0, 4.01609990319944, float, 1.0),
]
