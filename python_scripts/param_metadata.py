...
PARAM_METADATA = [
    ...
    ("MEDIUM_PERIOD_COEF_SCALE", 0.0, 100000.0, 258.1564, float, 1.0),
    ...
    ("DEEP_PERIOD_COEF_SCALE", 0.0, 100000.0, 4107.6983, float, 1.0),
    ...
    ("ROOT_LOOKAHEAD_DOWNGRADE_FRACTION", 0.0, 1.0, 0.03, float, 0.3),
    ("SHALLOW_LOOKAHEAD_DOWNGRADE_FRACTION", 0.0, 1.0, 0.03, float, 0.3),
    ("MEDIUM_LOOKAHEAD_DOWNGRADE_FRACTION", 0.0, 1.0, 0.03, float, 0.3),
    ("DEEP_LOOKAHEAD_DOWNGRADE_FRACTION", 0.0, 1.0, 0.03, float, 0.3),
